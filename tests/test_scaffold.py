...
class ScaffoldTest(unittest.TestCase):
    ...
    def test_image_provider_has_four_safe_cached_assets(self):
        ...
        self.assertIn('CONFIG["prompt_version"]', generator)
        for forbidden in ("No robot", "humanoid mascot", "stock illustration", "plastic skin"):
            self.assertIn(forbidden, generator)
